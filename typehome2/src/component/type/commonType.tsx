...
export type CounterAction = {type:"increase"} 
                     | {type:"decrease"}
                     | {type:"reset"}
                     | {type:"add", count:5}
...
export type CalculatorAction = {type:"ADD",x:string,y:string}
                              |{type:"SUB",x:string,y:string}
                              |{type:"DIV",x:string,y:string}
                              |{type:"MUL",x:string,y:string}
                              |{type:"RESET", x:string,y:string,result:number,
                               operator:string}
 
export type CalculatorAction2 = {type:"ADD",  value:CalulatorStateType}
